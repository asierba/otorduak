...
export function Settings({ weekStartDay, onWeekStartDayChange, theme, onThemeChange }: SettingsProps) {
  return (
    <div className="p-4 max-w-4xl mx-auto">
      <div className="bg-white dark:bg-gray-900 rounded-xl shadow-sm p-4 space-y-4">
        <div>
          ...
          <select
            ...
            className="px-3 py-2 text-sm border border-gray-300 dark:border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white dark:bg-gray-800 dark:text-gray-100"
          >
            {DAYS.map(day => (
