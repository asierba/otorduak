  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center">
      <div
        ...
        onClick={onClose}
      />
      <div className="relative w-full max-w-md bg-white dark:bg-gray-900 rounded-t-2xl max-h-[70vh] flex flex-col">
        <div className="p-4 border-b border-gray-100 dark:border-gray-800">
          ...
          <input
            ...
            className="w-full px-3 py-2 text-sm border border-gray-200 dark:border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white dark:bg-gray-800 dark:text-gray-100"
            autoFocus
          />
        </div>
        <div className="overflow-y-auto flex-1 pb-8">
          {filtered.map(m => (
            <button
              key={m.name}
              onClick={() => onToggle(m)}
              className={`w-full px-4 py-3 text-left text-sm border-b border-gray-50 dark:border-gray-800 flex items-center justify-between ${
