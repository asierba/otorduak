    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 p-4">
      <div className="max-w-4xl mx-auto">
        ...
        <input
          ...
          className="w-full mb-3 px-3 py-2 text-sm border border-gray-300 dark:border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white dark:bg-gray-900 dark:text-gray-100"
        />
            ...
            <button
              ...
              className={`px-3 py-1 text-xs rounded-full border transition-colors ${
                selectedTags.has(tag)
                  ...
                  : 'bg-white dark:bg-gray-900 text-gray-600 dark:text-gray-400 border-gray-300 dark:border-gray-700 hover:border-gray-400 dark:hover:border-gray-500'
              }`}
            >
              {tag}
            </button>
        ...
        <div className="space-y-1">
          {filteredMeals.map(meal => (
            <button
              ...
              className="w-full text-left px-4 py-3 bg-white dark:bg-gray-900 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 active:bg-gray-100 dark:active:bg-gray-700 transition-colors flex items-center justify-between"
            >
