    ...
    <div className="min-h-screen bg-gray-50 p-4">
      <div className="max-w-4xl mx-auto">
        ...
        <input
          ...
          className="w-full mb-3 px-3 py-2 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white"
        />
        ...
        <div className="space-y-1">
          {filteredMeals.map(meal => (
            <button
              ...
              className="w-full text-left px-4 py-3 bg-white rounded-lg hover:bg-gray-50 active:bg-gray-100 transition-colors flex items-center justify-between"
            >
          ...
          {filteredMeals.length === 0 && (
            <p className="text-center text-gray-400 py-8">No meals match the current filters</p>
          )}
        </div>
      </div>
    </div>
